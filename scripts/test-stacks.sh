...
DEFAULT_STACK_VERSIONS="9.5 9.4 9.3 9.2 9.1 9.0 8.19 8.18 8.17 8.16 8.15 8.14 8.13 8.12 8.11 8.10.1 8.9 8.8 8.7 8.6 8.5 8.4 8.3 8.2"
STACK_VERSIONS=
...
while [ $ITERATIONS -lt 0 ] || [ $ITERATION -lt $ITERATIONS ]; do
	...
	for MAJOR_MINOR in ${STACK_VERSIONS:-$DEFAULT_STACK_VERSIONS}; do
		...
		echo TEST_CORPUS_URI: $TEST_CORPUS_URI
