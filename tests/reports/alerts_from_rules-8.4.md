...
## Table of contents
   ...
   1. [Rules with the correct signals (639)](#rules-with-the-correct-signals-639)
...
## Rules with the correct signals (639)
...
```python
event.action:modified-user-account and host.os.type:windows and event.code:4738 and
