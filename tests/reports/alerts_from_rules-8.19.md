...
## Table of contents
   1. [Failed rules (19)](#failed-rules-19)
   1. [Unsuccessful rules with signals (19)](#unsuccessful-rules-with-signals-19)
   1. [Rules with no signals (4)](#rules-with-no-signals-4)
   1. [Rules with too few signals (23)](#rules-with-too-few-signals-23)
   1. [Rules with the correct signals (778)](#rules-with-the-correct-signals-778)
...
## Unsuccessful rules with signals (19)
...
## Rules with the correct signals (778)
