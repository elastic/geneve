...
Rules version: 8.19.12

## Table of contents
   1. [Failed rules (17)](#failed-rules-17)
   1. [Unsuccessful rules with signals (16)](#unsuccessful-rules-with-signals-16)
   1. [Rules with no signals (7)](#rules-with-no-signals-7)
   1. [Rules with too few signals (19)](#rules-with-too-few-signals-19)
   1. [Rules with the correct signals (953)](#rules-with-the-correct-signals-953)
...
## Unsuccessful rules with signals (16)
...
## Rules with the correct signals (953)
