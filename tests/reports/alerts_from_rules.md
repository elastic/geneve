...
```python
[{'event': {'dataset': 'azure.activitylogs', 'outcome': 'Success'}, 'azure': {'activitylogs': {'operation_name': 'MICROSOFT.NETWORK/XIUtkNI/STARTPACKETCAPTURE/ACTION'}}, '@timestamp': 0},
 {'event': {'dataset': 'azure.activitylogs', 'outcome': 'success'}, 'azure': {'activitylogs': {'operation_name': 'MICROSOFT.NETWORK/ixTFlEzswuEEXp/STARTPACKETCAPTURE/ACTION'}}, '@timestamp': 1},
 {'event': {'dataset': 'azure.activitylogs', 'outcome': 'Success'}, 'azure': {'activitylogs': {'operation_name': 'MICROSOFT.NETWORK/N/VPNCONNECTIONS/STARTPACKETCAPTURE/ACTION'}}, '@timestamp': 2},
 {'event': {'dataset': 'azure.activitylogs', 'outcome': 'success'}, 'azure': {'activitylogs': {'operation_name': 'MICROSOFT.NETWORK/iFqsyzKNyyQDpU/VPNCONNECTIONS/STARTPACKETCAPTURE/ACTION'}}, '@timestamp': 3},
 {'event': {'dataset': 'azure.activitylogs', 'outcome': 'Success'}, 'azure': {'activitylogs': {'operation_name': 'MICROSOFT.NETWORK/lOPZRgUvWCiMZOf/PACKETCAPTURES/WRITE'}}, '@timestamp': 4},
 {'event': {'dataset': 'azure.activitylogs', 'outcome': 'success'}, 'azure': {'activitylogs': {'operation_name': 'MICROSOFT.NETWORK/s/PACKETCAPTURES/WRITE'}}, '@timestamp': 5}]
```
...
[{'event': {'category': ['network'], 'dataset': 'zeek.dns'}, 'destination': {'port': 53}, 'network': {'bytes': 4289315490}, '@timestamp': 0},
 {'event': {'category': ['network']}, 'destination': {'port': 53}, 'network': {'bytes': 3844421733}, 'type': 'dns', '@timestamp': 1},
 ...
 {'event': {'category': ['network_traffic']}, 'destination': {'port': 53}, 'network': {'bytes': 2043283025}, 'type': 'dns', '@timestamp': 4},
...
[{'event': {'category': ['file'], 'type': ['change']}, 'process': {'name': 'ZFy', 'executable': 'XIU'}, 'file': {'path': '/private/etc/rc.local'}, '@timestamp': 0},
 ...
 {'event': {'category': ['file'], 'type': ['change']}, 'process': {'name': 'xTF', 'executable': 'lEz'}, 'file': {'path': '/home/wuEE/.profile'}, '@timestamp': 2},
 {'event': {'category': ['file'], 'type': ['change']}, 'process': {'name': 'XpW', 'executable': 'qNV'}, 'file': {'path': '/home/F/.profile1'}, '@timestamp': 3},
 {'event': {'category': ['file'], 'type': ['change']}, 'process': {'name': 'qsy', 'executable': 'zKN'}, 'file': {'path': '/home/MGzNfmlO/.bash_profile'}, '@timestamp': 4},
 {'event': {'category': ['file'], 'type': ['change']}, 'process': {'name': 'PZR', 'executable': 'gUv'}, 'file': {'path': '/home/imrFgTmsh/.bash_profile1'}, '@timestamp': 5},
 {'event': {'category': ['file'], 'type': ['change']}, 'process': {'name': 'CeL', 'executable': 'WYc'}, 'file': {'path': '/home/cnU/.bashrc'}, '@timestamp': 6},
 {'event': {'category': ['file'], 'type': ['change']}, 'process': {'name': 'JMV', 'executable': 'rHt'}, 'file': {'path': '/Users/IgeXgN/.bash_profile'}, '@timestamp': 7},
 {'event': {'category': ['file'], 'type': ['change']}, 'process': {'name': 'moE', 'executable': 'FCE'}, 'file': {'path': '/Users/gIkbkuYnDm/.zshenv'}, '@timestamp': 8}]
```
...
```python
[{'network': {'protocol': 'dns'}, 'process': {'name': 'ZFy', 'executable': 'XIU'}, 'user': {'id': 'tkN'}, 'dns': {'question': {'name': 'discordapp.com'}}, 'event': {'category': ['network']}, '@timestamp': 0}]
```
...
```python
[{'event': {'category': ['network'], 'type': ['connection']}, 'destination': {'port': 53, 'ip': '222.151.68.226'}, 'source': {'ip': '10.214.62.131'}, '@timestamp': 0},
 {'event': {'category': ['network'], 'type': ['connection']}, 'destination': {'port': 53, 'ip': '170.121.236.89'}, 'source': {'ip': '172.28.20.160'}, '@timestamp': 1},
 {'event': {'category': ['network'], 'type': ['connection']}, 'destination': {'port': 53, 'ip': '54.2.158.30'}, 'source': {'ip': '192.168.96.70'}, '@timestamp': 2},
 {'event': {'category': ['network'], 'type': ['connection'], 'dataset': 'zeek.dns'}, 'source': {'ip': '10.81.75.61'}, 'destination': {'ip': '115.189.242.190'}, '@timestamp': 3},
 ...
 {'event': {'category': ['network']}, 'destination': {'port': 53, 'ip': '98.189.16.220'}, 'source': {'ip': '10.44.10.19'}, 'type': 'dns', '@timestamp': 6},
 {'event': {'category': ['network']}, 'destination': {'port': 53, 'ip': '197.7.114.246'}, 'source': {'ip': '172.16.20.234'}, 'type': 'dns', '@timestamp': 7},
 {'event': {'category': ['network']}, 'destination': {'port': 53, 'ip': 'd5e4:e45:48d:758d:eac9:ff60:21ff:ce20'}, 'source': {'ip': '192.168.29.111'}, 'type': 'dns', '@timestamp': 8},
 {'event': {'category': ['network'], 'dataset': 'zeek.dns'}, 'source': {'ip': '10.162.120.245'}, 'destination': {'ip': '93.16.168.118'}, 'type': 'dns', '@timestamp': 9},
 {'event': {'category': ['network'], 'dataset': 'zeek.dns'}, 'source': {'ip': '172.31.119.58'}, 'destination': {'ip': '178.204.52.89'}, 'type': 'dns', '@timestamp': 10},
 {'event': {'category': ['network'], 'dataset': 'zeek.dns'}, 'source': {'ip': '192.168.239.247'}, 'destination': {'ip': '7ee8:2ac7:8fd8:c24b:a168:4644:d2ea:bc0f'}, 'type': 'dns', '@timestamp': 11},
 {'event': {'category': ['network_traffic'], 'type': ['connection']}, 'destination': {'port': 53, 'ip': '196.226.36.190'}, 'source': {'ip': '10.120.95.125'}, '@timestamp': 12},
 {'event': {'category': ['network_traffic'], 'type': ['connection']}, 'destination': {'port': 53, 'ip': '147.172.30.18'}, 'source': {'ip': '172.30.115.209'}, '@timestamp': 13},
 {'event': {'category': ['network_traffic'], 'type': ['connection']}, 'destination': {'port': 53, 'ip': '200.44.53.86'}, 'source': {'ip': '192.168.189.205'}, '@timestamp': 14},
 {'event': {'category': ['network_traffic'], 'type': ['connection'], 'dataset': 'zeek.dns'}, 'source': {'ip': '10.84.67.229'}, 'destination': {'ip': '189.141.142.160'}, '@timestamp': 15},
 {'event': {'category': ['network_traffic'], 'type': ['connection'], 'dataset': 'zeek.dns'}, 'source': {'ip': '172.20.11.158'}, 'destination': {'ip': '60.8.116.38'}, '@timestamp': 16},
 {'event': {'category': ['network_traffic'], 'type': ['connection'], 'dataset': 'zeek.dns'}, 'source': {'ip': '192.168.178.22'}, 'destination': {'ip': '147.73.59.170'}, '@timestamp': 17},
 {'event': {'category': ['network_traffic']}, 'destination': {'port': 53, 'ip': '29.217.128.30'}, 'source': {'ip': '10.251.37.73'}, 'type': 'dns', '@timestamp': 18},
 {'event': {'category': ['network_traffic']}, 'destination': {'port': 53, 'ip': 'f932:b472:ada9:b71c:ed94:51ca:d746:364d'}, 'source': {'ip': '172.17.96.216'}, 'type': 'dns', '@timestamp': 19},
 {'event': {'category': ['network_traffic']}, 'destination': {'port': 53, 'ip': '46.77.189.36'}, 'source': {'ip': '192.168.139.227'}, 'type': 'dns', '@timestamp': 20},
 {'event': {'category': ['network_traffic'], 'dataset': 'zeek.dns'}, 'source': {'ip': '10.168.18.80'}, 'destination': {'ip': '59.124.104.23'}, 'type': 'dns', '@timestamp': 21},
 {'event': {'category': ['network_traffic'], 'dataset': 'zeek.dns'}, 'source': {'ip': '172.29.169.80'}, 'destination': {'ip': '146.110.7.176'}, 'type': 'dns', '@timestamp': 22},
 {'event': {'category': ['network_traffic'], 'dataset': 'zeek.dns'}, 'source': {'ip': '192.168.253.192'}, 'destination': {'ip': '169.49.132.205'}, 'type': 'dns', '@timestamp': 23}]
```
...
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'net.exe', 'args': ['group', 'user', 'localgroup', 'admin', 'Domain Admins', 'Remote Desktop Users', 'Enterprise Admins', 'Organization Management']}, '@timestamp': 0},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['group', 'user', 'localgroup', 'admin', 'Domain Admins', 'Remote Desktop Users', 'Enterprise Admins', 'Organization Management'], 'parent': {'name': 'ZFy'}}, '@timestamp': 2},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'pe': {'original_file_name': 'net1.exe'}, 'args': ['group', 'user', 'localgroup', 'admin', 'Domain Admins', 'Remote Desktop Users', 'Enterprise Admins', 'Organization Management'], 'parent': {'name': 'XIU'}}, '@timestamp': 3},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['group', 'user', 'localgroup', 'admin', 'Domain Admins', 'Remote Desktop Users', 'Enterprise Admins', 'Organization Management'], 'parent': {'name': 'tkN'}}, '@timestamp': 6},
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'pe': {'original_file_name': 'net1.exe'}, 'args': ['group', 'user', 'localgroup', 'admin', 'Domain Admins', 'Remote Desktop Users', 'Enterprise Admins', 'Organization Management'], 'parent': {'name': 'Ioi'}}, '@timestamp': 7},
...
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'userinit.exe', 'parent': {'name': 'winlogon.exe'}}, 'host': {'id': 'ZFy'}, 'user': {'name': 'XIU'}, '@timestamp': 0},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'cscript.exe'}}, 'host': {'id': 'ZFy'}, 'user': {'name': 'XIU'}, '@timestamp': 2},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'wscript.exe'}}, 'host': {'id': 'tkN'}, 'user': {'name': 'Ioi'}, '@timestamp': 5},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'PowerShell.EXE'}}, 'host': {'id': 'xTF'}, 'user': {'name': 'lEz'}, '@timestamp': 8},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSHTA.EXE'}}, 'host': {'id': 'swu'}, 'user': {'name': 'EEX'}, '@timestamp': 11},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RUNDLL32.EXE'}}, 'host': {'id': 'pWq'}, 'user': {'name': 'NVR'}, '@timestamp': 14},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'REGSVR32.EXE'}}, 'host': {'id': 'cym'}, 'user': {'name': 'EEw'}, '@timestamp': 17},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RegAsm.exe'}}, 'host': {'id': 'VPY'}, 'user': {'name': 'MGz'}, '@timestamp': 20},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSBuild.exe'}}, 'host': {'id': 'Nfm'}, 'user': {'name': 'lOP'}, '@timestamp': 23},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'InstallUtil.exe'}}, 'host': {'id': 'ZRg'}, 'user': {'name': 'UvW'}, '@timestamp': 26},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'cscript.exe'}}, 'host': {'id': 'CiM'}, 'user': {'name': 'ZOf'}, '@timestamp': 29},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'wscript.exe'}}, 'host': {'id': 'HaT'}, 'user': {'name': 'Dgz'}, '@timestamp': 32},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'PowerShell.EXE'}}, 'host': {'id': 'RJi'}, 'user': {'name': 'LSj'}, '@timestamp': 35},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSHTA.EXE'}}, 'host': {'id': 'oGr'}, 'user': {'name': 'myw'}, '@timestamp': 38},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RUNDLL32.EXE'}}, 'host': {'id': 'DUN'}, 'user': {'name': 'rZj'}, '@timestamp': 41},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'REGSVR32.EXE'}}, 'host': {'id': 'eyL'}, 'user': {'name': 'uZf'}, '@timestamp': 44},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RegAsm.exe'}}, 'host': {'id': 'Izm'}, 'user': {'name': 'iEG'}, '@timestamp': 47},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSBuild.exe'}}, 'host': {'id': 'gav'}, 'user': {'name': 'KEI'}, '@timestamp': 50},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'InstallUtil.exe'}}, 'host': {'id': 'pdu'}, 'user': {'name': 'DJL'}, '@timestamp': 53},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'cscript.exe'}}, 'host': {'id': 'Mru'}, 'user': {'name': 'Toc'}, '@timestamp': 56},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'wscript.exe'}}, 'host': {'id': 'svB'}, 'user': {'name': 'ayA'}, '@timestamp': 59},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'PowerShell.EXE'}}, 'host': {'id': 'olI'}, 'user': {'name': 'YAR'}, '@timestamp': 62},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSHTA.EXE'}}, 'host': {'id': 'LbR'}, 'user': {'name': 'zWY'}, '@timestamp': 65},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RUNDLL32.EXE'}}, 'host': {'id': 'srf'}, 'user': {'name': 'ybO'}, '@timestamp': 68},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'REGSVR32.EXE'}}, 'host': {'id': 'YUa'}, 'user': {'name': 'gTr'}, '@timestamp': 71},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RegAsm.exe'}}, 'host': {'id': 'NYj'}, 'user': {'name': 'LwO'}, '@timestamp': 74},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSBuild.exe'}}, 'host': {'id': 'Tvb'}, 'user': {'name': 'zIv'}, '@timestamp': 77},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'InstallUtil.exe'}}, 'host': {'id': 'lLx'}, 'user': {'name': 'tPu'}, '@timestamp': 80},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'cscript.exe'}}, 'host': {'id': 'AMM'}, 'user': {'name': 'Fqp'}, '@timestamp': 83},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'wscript.exe'}}, 'host': {'id': 'kOO'}, 'user': {'name': 'kis'}, '@timestamp': 86},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'PowerShell.EXE'}}, 'host': {'id': 'thB'}, 'user': {'name': 'Czn'}, '@timestamp': 89},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSHTA.EXE'}}, 'host': {'id': 'Njd'}, 'user': {'name': 'yQm'}, '@timestamp': 92},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RUNDLL32.EXE'}}, 'host': {'id': 'SbA'}, 'user': {'name': 'gZp'}, '@timestamp': 95},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'REGSVR32.EXE'}}, 'host': {'id': 'GZa'}, 'user': {'name': 'Tdb'}, '@timestamp': 98},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RegAsm.exe'}}, 'host': {'id': 'FRI'}, 'user': {'name': 'sji'}, '@timestamp': 101},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSBuild.exe'}}, 'host': {'id': 'LnP'}, 'user': {'name': 'tYo'}, '@timestamp': 104},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'InstallUtil.exe'}}, 'host': {'id': 'Ufu'}, 'user': {'name': 'FWk'}, '@timestamp': 107},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'cscript.exe'}}, 'host': {'id': 'PRa'}, 'user': {'name': 'QXr'}, '@timestamp': 110},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'wscript.exe'}}, 'host': {'id': 'kNg'}, 'user': {'name': 'yXL'}, '@timestamp': 113},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'PowerShell.EXE'}}, 'host': {'id': 'ZiZ'}, 'user': {'name': 'pAg'}, '@timestamp': 116},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSHTA.EXE'}}, 'host': {'id': 'pPT'}, 'user': {'name': 'PzX'}, '@timestamp': 119},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RUNDLL32.EXE'}}, 'host': {'id': 'Lhv'}, 'user': {'name': 'NEh'}, '@timestamp': 122},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'REGSVR32.EXE'}}, 'host': {'id': 'Rrd'}, 'user': {'name': 'FNh'}, '@timestamp': 125},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RegAsm.exe'}}, 'host': {'id': 'oQP'}, 'user': {'name': 'sNG'}, '@timestamp': 128},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSBuild.exe'}}, 'host': {'id': 'ATJ'}, 'user': {'name': 'mwZ'}, '@timestamp': 131},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'InstallUtil.exe'}}, 'host': {'id': 'HQy'}, 'user': {'name': 'Bcb'}, '@timestamp': 134},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'cscript.exe'}}, 'host': {'id': 'qJj'}, 'user': {'name': 'vmQ'}, '@timestamp': 137},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'wscript.exe'}}, 'host': {'id': 'EYJ'}, 'user': {'name': 'XuO'}, '@timestamp': 140},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'PowerShell.EXE'}}, 'host': {'id': 'LNy'}, 'user': {'name': 'JDj'}, '@timestamp': 143},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSHTA.EXE'}}, 'host': {'id': 'LAG'}, 'user': {'name': 'yXj'}, '@timestamp': 146},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RUNDLL32.EXE'}}, 'host': {'id': 'TFO'}, 'user': {'name': 'gMM'}, '@timestamp': 149},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'REGSVR32.EXE'}}, 'host': {'id': 'Pkz'}, 'user': {'name': 'BsU'}, '@timestamp': 152},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RegAsm.exe'}}, 'host': {'id': 'TCj'}, 'user': {'name': 'fwZ'}, '@timestamp': 155},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSBuild.exe'}}, 'host': {'id': 'iGt'}, 'user': {'name': 'xuX'}, '@timestamp': 158},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'InstallUtil.exe'}}, 'host': {'id': 'xWg'}, 'user': {'name': 'uzn'}, '@timestamp': 161},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'cscript.exe'}}, 'host': {'id': 'kkC'}, 'user': {'name': 'GpD'}, '@timestamp': 164},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'wscript.exe'}}, 'host': {'id': 'BGQ'}, 'user': {'name': 'zgU'}, '@timestamp': 167},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'PowerShell.EXE'}}, 'host': {'id': 'Nph'}, 'user': {'name': 'HcY'}, '@timestamp': 170},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSHTA.EXE'}}, 'host': {'id': 'efW'}, 'user': {'name': 'ryE'}, '@timestamp': 173},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RUNDLL32.EXE'}}, 'host': {'id': 'YNp'}, 'user': {'name': 'ksi'}, '@timestamp': 176},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'REGSVR32.EXE'}}, 'host': {'id': 'hfo'}, 'user': {'name': 'HNU'}, '@timestamp': 179},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RegAsm.exe'}}, 'host': {'id': 'tWb'}, 'user': {'name': 'yTv'}, '@timestamp': 182},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSBuild.exe'}}, 'host': {'id': 'xUm'}, 'user': {'name': 'tVt'}, '@timestamp': 185},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'InstallUtil.exe'}}, 'host': {'id': 'nYh'}, 'user': {'name': 'bqj'}, '@timestamp': 188},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'cscript.exe'}}, 'host': {'id': 'oFZ'}, 'user': {'name': 'iFm'}, '@timestamp': 191},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'wscript.exe'}}, 'host': {'id': 'hdx'}, 'user': {'name': 'tgm'}, '@timestamp': 194},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'PowerShell.EXE'}}, 'host': {'id': 'FTY'}, 'user': {'name': 'eaU'}, '@timestamp': 197},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSHTA.EXE'}}, 'host': {'id': 'qVU'}, 'user': {'name': 'CGs'}, '@timestamp': 200},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RUNDLL32.EXE'}}, 'host': {'id': 'tMP'}, 'user': {'name': 'VTT'}, '@timestamp': 203},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'REGSVR32.EXE'}}, 'host': {'id': 'USR'}, 'user': {'name': 'JtZ'}, '@timestamp': 206},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'RegAsm.exe'}}, 'host': {'id': 'gOH'}, 'user': {'name': 'Zpa'}, '@timestamp': 209},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'MSBuild.exe'}}, 'host': {'id': 'waE'}, 'user': {'name': 'Mwa'}, '@timestamp': 212},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'parent': {'name': 'explorer.exe'}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*'], 'pe': {'original_file_name': 'InstallUtil.exe'}}, 'host': {'id': 'NUW'}, 'user': {'name': 'Bkk'}, '@timestamp': 215}]
```
...
[{'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'osascript'}}, '@timestamp': 0},
 ...
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'pythonXIUtkNI'}}, '@timestamp': 6},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'perlixTFlEzswuEEXp'}}, '@timestamp': 7},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'phpN'}}, '@timestamp': 8},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'ruby'}}, '@timestamp': 9},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'pwsh'}}, '@timestamp': 10},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'osascript'}}, '@timestamp': 11},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'com.apple.automator.runner'}}, '@timestamp': 12},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'sh'}}, '@timestamp': 13},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'bash'}}, '@timestamp': 14},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'dash'}}, '@timestamp': 15},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'zsh'}}, '@timestamp': 16},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'pythoniFqsyzKNyyQDpU'}}, '@timestamp': 17},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'perllOPZRgUvWCiMZOf'}}, '@timestamp': 18},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'phps'}}, '@timestamp': 19},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'ruby'}}, '@timestamp': 20},
 {'event': {'category': ['process'], 'type': ['process_started']}, 'process': {'name': 'security_authtrampoline', 'parent': {'name': 'pwsh'}}, '@timestamp': 21}]
```
...
```python
[{'network': {'protocol': 'dns'}, 'process': {'name': 'ZFy', 'executable': 'XIU'}, 'user': {'id': 'tkN'}, 'event': {'action': 'lookup_requested', 'category': ['network']}, 'dns': {'question': {'name': 'SvILOip-lookup.net'}}, '@timestamp': 0}]
```
...
```python
[{'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 20, 'ip': 'aa79:ec58:8d14:2981:f18d:f2a6:6b1f:4182'}, 'source': {'ip': '10.193.74.7'}, '@timestamp': 0},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 20, 'ip': '9a9f:e89a:c443:b67a:770a:2cd7:3602:9e1e'}, 'source': {'ip': '172.25.51.169'}, '@timestamp': 1},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 20, 'ip': '104.129.204.102'}, 'source': {'ip': '192.168.111.13'}, '@timestamp': 2},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 21, 'ip': '149.239.86.175'}, 'source': {'ip': '10.186.159.60'}, '@timestamp': 3},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 21, 'ip': '112.141.185.70'}, 'source': {'ip': '172.28.87.162'}, '@timestamp': 4},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 21, 'ip': 'b781:36ad:968a:1fd9:42e0:603d:9566:7ca8'}, 'source': {'ip': '192.168.155.175'}, '@timestamp': 5},
 {'event': {'category': ['network'], 'dataset': 'zeek.ftp'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '10.1.78.172'}, 'destination': {'ip': '213.228.14.70'}, '@timestamp': 6},
 {'event': {'category': ['network'], 'dataset': 'zeek.ftp'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '172.17.214.243'}, 'destination': {'ip': '9795:5b:5d10:a875:3fd5:d939:513c:7adf'}, '@timestamp': 7},
 {'event': {'category': ['network'], 'dataset': 'zeek.ftp'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '192.168.247.115'}, 'destination': {'ip': 'cde8:687a:c169:7ee6:e8d4:8f4f:b2cc:3459'}, '@timestamp': 8},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 20, 'ip': 'd2ea:bc0e:bba3:4c8f:77fb:cabb:f82a:fe57'}, 'source': {'ip': '10.151.5.37'}, '@timestamp': 9},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 20, 'ip': '149.249.47.200'}, 'source': {'ip': '172.23.71.191'}, '@timestamp': 10},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 20, 'ip': '203.126.47.30'}, 'source': {'ip': '192.168.61.174'}, '@timestamp': 11},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 21, 'ip': '8b3b:3c21:5ee6:cf96:edef:c0fa:ed30:de6f'}, 'source': {'ip': '10.84.67.229'}, '@timestamp': 12},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 21, 'ip': '189.141.142.160'}, 'source': {'ip': '172.20.11.158'}, '@timestamp': 13},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 21, 'ip': '3.79.219.137'}, 'source': {'ip': '192.168.77.111'}, '@timestamp': 14},
 {'event': {'category': ['network_traffic'], 'dataset': 'zeek.ftp'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '10.46.186.157'}, 'destination': {'ip': 'ada9:b71c:ed94:51ca:d746:364c:b861:3a66'}, '@timestamp': 15},
...
```python
[{'event': {'dataset': 'googlecloud.audit', 'action': 'io.k8s.authorization.rbac.vXIUtkNI.clusterrolebindings.create', 'outcome': 'success'}, 'gcp': {'audit': {'authentication_info': {'principal_email': 'oix'}}}, '@timestamp': 0},
 {'event': {'dataset': 'googlecloud.audit', 'action': 'io.k8s.authorization.rbac.vEzswu.rolebindings.create', 'outcome': 'success'}, 'gcp': {'audit': {'authentication_info': {'principal_email': 'EEX'}}}, '@timestamp': 1},
 {'event': {'dataset': 'googlecloud.audit', 'action': 'io.k8s.authorization.rbac.vWqNVRcymEEwVP.clusterrolebindings.patch', 'outcome': 'success'}, 'gcp': {'audit': {'authentication_info': {'principal_email': 'YMG'}}}, '@timestamp': 2},
 {'event': {'dataset': 'googlecloud.audit', 'action': 'io.k8s.authorization.rbac.vNfmlO.rolebindings.patch', 'outcome': 'success'}, 'gcp': {'audit': {'authentication_info': {'principal_email': 'PZR'}}}, '@timestamp': 3},
 {'event': {'dataset': 'gcp.audit', 'action': 'io.k8s.authorization.rbac.vUvWCiMZOfHaTD.clusterrolebindings.create', 'outcome': 'success'}, 'gcp': {'audit': {'authentication_info': {'principal_email': 'gzR'}}}, '@timestamp': 4},
 {'event': {'dataset': 'gcp.audit', 'action': 'io.k8s.authorization.rbac.vL.rolebindings.create', 'outcome': 'success'}, 'gcp': {'audit': {'authentication_info': {'principal_email': 'Sjo'}}}, '@timestamp': 5},
 {'event': {'dataset': 'gcp.audit', 'action': 'io.k8s.authorization.rbac.vmywDUNrZjeyL.clusterrolebindings.patch', 'outcome': 'success'}, 'gcp': {'audit': {'authentication_info': {'principal_email': 'uZf'}}}, '@timestamp': 6},
 {'event': {'dataset': 'gcp.audit', 'action': 'io.k8s.authorization.rbac.vmiEGgavKE.rolebindings.patch', 'outcome': 'success'}, 'gcp': {'audit': {'authentication_info': {'principal_email': 'Ipd'}}}, '@timestamp': 7}]
```
...
```python
[{'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6667, 'ip': 'aa79:ec58:8d14:2981:f18d:f2a6:6b1f:4182'}, 'source': {'ip': '10.193.74.7'}, '@timestamp': 0},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6667, 'ip': '9a9f:e89a:c443:b67a:770a:2cd7:3602:9e1e'}, 'source': {'ip': '172.25.51.169'}, '@timestamp': 1},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6667, 'ip': '104.129.204.102'}, 'source': {'ip': '192.168.111.13'}, '@timestamp': 2},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6697, 'ip': '149.239.86.175'}, 'source': {'ip': '10.186.159.60'}, '@timestamp': 3},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6697, 'ip': '112.141.185.70'}, 'source': {'ip': '172.28.87.162'}, '@timestamp': 4},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6697, 'ip': 'b781:36ad:968a:1fd9:42e0:603d:9566:7ca8'}, 'source': {'ip': '192.168.155.175'}, '@timestamp': 5},
 {'event': {'category': ['network'], 'dataset': 'zeek.irc'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '10.1.78.172'}, 'destination': {'ip': '213.228.14.70'}, '@timestamp': 6},
 {'event': {'category': ['network'], 'dataset': 'zeek.irc'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '172.17.214.243'}, 'destination': {'ip': '9795:5b:5d10:a875:3fd5:d939:513c:7adf'}, '@timestamp': 7},
 {'event': {'category': ['network'], 'dataset': 'zeek.irc'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '192.168.247.115'}, 'destination': {'ip': 'cde8:687a:c169:7ee6:e8d4:8f4f:b2cc:3459'}, '@timestamp': 8},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6667, 'ip': 'd2ea:bc0e:bba3:4c8f:77fb:cabb:f82a:fe57'}, 'source': {'ip': '10.151.5.37'}, '@timestamp': 9},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6667, 'ip': '149.249.47.200'}, 'source': {'ip': '172.23.71.191'}, '@timestamp': 10},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6667, 'ip': '203.126.47.30'}, 'source': {'ip': '192.168.61.174'}, '@timestamp': 11},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6697, 'ip': '8b3b:3c21:5ee6:cf96:edef:c0fa:ed30:de6f'}, 'source': {'ip': '10.84.67.229'}, '@timestamp': 12},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6697, 'ip': '189.141.142.160'}, 'source': {'ip': '172.20.11.158'}, '@timestamp': 13},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 6697, 'ip': '3.79.219.137'}, 'source': {'ip': '192.168.77.111'}, '@timestamp': 14},
 {'event': {'category': ['network_traffic'], 'dataset': 'zeek.irc'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '10.46.186.157'}, 'destination': {'ip': 'ada9:b71c:ed94:51ca:d746:364c:b861:3a66'}, '@timestamp': 15},
...
```python
[{'event': {'type': ['start'], 'category': ['network']}, 'network': {'direction': 'outgoing'}, 'destination': {'port': 88, 'address': 'vCf'}, 'source': {'port': 61522}, 'process': {'executable': 'yyF', 'name': 'jSv'}, '@timestamp': 0}]
```
...
[{'event': {'category': ['file'], 'type': ['change']}, 'file': {'name': 'pam_XIUtkNI.so', 'path': 'oix'}, 'process': {'executable': 'TFl'}, '@timestamp': 0},
 {'event': {'category': ['file'], 'type': ['change']}, 'file': {'path': '/etc/pam.d/swuEEXpWqNV'}, 'process': {'executable': 'Rcy'}, '@timestamp': 1},
 {'event': {'category': ['file'], 'type': ['change']}, 'file': {'path': '/private/etc/pam.d/EEwVPY'}, 'process': {'executable': 'MGz'}, '@timestamp': 2}]
```
...
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'net.exe', 'args': ['use', '\\\\*\\*$*', '\\\\*@SSL\\*', 'http*']}, '@timestamp': 0},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['use', '\\\\*\\*$*', '\\\\*@SSL\\*', 'http*'], 'parent': {'name': 'ZFy'}}, '@timestamp': 2},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'pe': {'original_file_name': 'net1.exe'}, 'args': ['use', '\\\\*\\*$*', '\\\\*@SSL\\*', 'http*'], 'parent': {'name': 'XIU'}}, '@timestamp': 3},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['use', '\\\\*\\*$*', '\\\\*@SSL\\*', 'http*'], 'parent': {'name': 'tkN'}}, '@timestamp': 6},
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'pe': {'original_file_name': 'net1.exe'}, 'args': ['use', '\\\\*\\*$*', '\\\\*@SSL\\*', 'http*'], 'parent': {'name': 'Ioi'}}, '@timestamp': 7}]
```
...
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'Ext': {'token': {'integrity_level_name': 'System'}}, 'name': 'elevation_service.exe', 'pe': {'original_file_name': 'ZFy'}}, '@timestamp': 0},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'Ext': {'token': {'integrity_level_name': 'System'}}, 'name': 'rundll32.exe', 'parent': {'name': 'elevation_service.exe'}}, '@timestamp': 1},
...
```python
[{'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 1080, 'ip': 'aa79:ec58:8d14:2981:f18d:f2a6:6b1f:4182'}, 'source': {'ip': '10.193.74.7'}, '@timestamp': 0},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 1080, 'ip': '9a9f:e89a:c443:b67a:770a:2cd7:3602:9e1e'}, 'source': {'ip': '172.25.51.169'}, '@timestamp': 1},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 1080, 'ip': '104.129.204.102'}, 'source': {'ip': '192.168.111.13'}, '@timestamp': 2},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 3128, 'ip': '149.239.86.175'}, 'source': {'ip': '10.186.159.60'}, '@timestamp': 3},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 3128, 'ip': '112.141.185.70'}, 'source': {'ip': '172.28.87.162'}, '@timestamp': 4},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 3128, 'ip': 'b781:36ad:968a:1fd9:42e0:603d:9566:7ca8'}, 'source': {'ip': '192.168.155.175'}, '@timestamp': 5},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 8080, 'ip': '21ff:ce1f:c206:4389:a7:5646:506a:fac3'}, 'source': {'ip': '10.81.180.150'}, '@timestamp': 6},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 8080, 'ip': '156.105.128.203'}, 'source': {'ip': '172.26.39.143'}, '@timestamp': 7},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 8080, 'ip': '93.16.168.118'}, 'source': {'ip': '192.168.247.115'}, '@timestamp': 8},
 {'event': {'category': ['network'], 'dataset': 'zeek.socks'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '10.240.129.212'}, 'destination': {'ip': '8fd8:c24b:a168:4644:d2ea:bc0e:bba3:4c90'}, '@timestamp': 9},
 {'event': {'category': ['network'], 'dataset': 'zeek.socks'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '172.25.112.82'}, 'destination': {'ip': '149.249.47.200'}, '@timestamp': 10},
 {'event': {'category': ['network'], 'dataset': 'zeek.socks'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '192.168.116.123'}, 'destination': {'ip': '203.126.47.30'}, '@timestamp': 11},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 1080, 'ip': 'dd8c:481d:d693:36a4:eaa1:660b:fe6b:8958'}, 'source': {'ip': '10.209.145.8'}, '@timestamp': 12},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 1080, 'ip': '139.59.60.34'}, 'source': {'ip': '172.21.68.62'}, '@timestamp': 13},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 1080, 'ip': '189.141.142.160'}, 'source': {'ip': '192.168.64.185'}, '@timestamp': 14},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 

 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 22, 'ip': 'cde8:687a:c169:7ee6:e8d4:8f4f:b2cc:3459'}, 'source': {'ip': '192.168.239.247'}, '@timestamp': 8},
 {'event': {'category': ['network_traffic'], 'dataset': 'zeek.ssh'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '10.151.5.37'}, 'destination': {'ip': '149.249.47.200'}, '@timestamp': 9},
 {'event': {'category': ['network_traffic'], 'dataset': 'zeek.ssh'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '172.23.71.191'}, 'destination': {'ip': '203.126.47.30'}, '@timestamp': 10},
 {'event': {'category': ['network_traffic'], 'dataset': 'zeek.ssh'}, 'network': {'transport': 'tcp'}, 'source': {'ip': '192.168.61.174'}, 'destination': {'ip': '8b3b:3c21:5ee6:cf96:edef:c0fa:ed30:de6f'}, '@timestamp': 11}]
```
...
```python
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'grep', 'args': ['Little Snitch*', 'Avast*', 'Avira*', 'ESET*', 'BlockBlock*', '360Sec*', 'LuLu*', 'KnockKnock*', 'kav', 'KIS', 'RTProtectionDaemon*', 'Malware*', 'VShieldScanner*', 'WebProtection*', 'webinspectord*', 'McAfee*', 'isecespd*', 'macmnsvc*', 'masvc*', 'kesl*', 'avscan*', 'guard*', 'rtvscand*', 'symcfgd*', 'scmdaemon*', 'symantec*', 'sophos*', 'osquery*', 'elastic-endpoint*'], 'parent': {'executable': 'ZFy'}}, 'user': {'id': 'XIU'}, '@timestamp': 0},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'grep', 'args': ['Little Snitch*', 'Avast*', 'Avira*', 'ESET*', 'BlockBlock*', '360Sec*', 'LuLu*', 'KnockKnock*', 'kav', 'KIS', 'RTProtectionDaemon*', 'Malware*', 'VShieldScanner*', 'WebProtection*', 'webinspectord*', 'McAfee*', 'isecespd*', 'macmnsvc*', 'masvc*', 'kesl*', 'avscan*', 'guard*', 'rtvscand*', 'symcfgd*', 'scmdaemon*', 'symantec*', 'sophos*', 'osquery*', 'elastic-endpoint*'], 'parent': {'executable': 'tkN'}}, 'user': {'id': 'Ioi'}, '@timestamp': 1}]
```
...
[{'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/root/.ssh/id_rsa']}, '@timestamp': 0},
 ...
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.ssh/id_rsa']}, '@timestamp': 9},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.ssh/id_rsa.pub']}, '@timestamp': 10},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.ssh/id_ed25519']}, '@timestamp': 11},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.ssh/id_ed25519.pub']}, '@timestamp': 12},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.ssh/authorized_keys']}, '@timestamp': 13},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.ssh/authorized_keys2']}, '@timestamp': 14},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.ssh/known_hosts']}, '@timestamp': 15},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.bash_history']}, '@timestamp': 16},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/root/.aws/credentials']}, '@timestamp': 17},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/root/.aws/config']}, '@timestamp': 18},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.aws/credentials']}, '@timestamp': 19},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.aws/config']}, '@timestamp': 20},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/root/.docker/config.json']}, '@timestamp': 21},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/home/*/.docker/config.json']}, '@timestamp': 22},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/etc/group']}, '@timestamp': 23},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/etc/passwd']}, '@timestamp': 24},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/etc/shadow']}, '@timestamp': 25},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'zip', 'args': ['/etc/gshadow']}, '@timestamp': 26},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.ssh/id_rsa']}, '@timestamp': 27},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.ssh/id_rsa.pub']}, '@timestamp': 28},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.ssh/id_ed25519']}, '@timestamp': 29},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.ssh/id_ed25519.pub']}, '@timestamp': 30},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.ssh/authorized_keys']}, '@timestamp': 31},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.ssh/authorized_keys2']}, '@timestamp': 32},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.ssh/known_hosts']}, '@timestamp': 33},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.bash_history']}, '@timestamp': 34},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/etc/hosts']}, '@timestamp': 35},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.ssh/id_rsa']}, '@timestamp': 36},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.ssh/id_rsa.pub']}, '@timestamp': 37},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.ssh/id_ed25519']}, '@timestamp': 38},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.ssh/id_ed25519.pub']}, '@timestamp': 39},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.ssh/authorized_keys']}, '@timestamp': 40},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.ssh/authorized_keys2']}, '@timestamp': 41},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.ssh/known_hosts']}, '@timestamp': 42},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.bash_history']}, '@timestamp': 43},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.aws/credentials']}, '@timestamp': 44},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.aws/config']}, '@timestamp': 45},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.aws/credentials']}, '@timestamp': 46},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.aws/config']}, '@timestamp': 47},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/root/.docker/config.json']}, '@timestamp': 48},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/home/*/.docker/config.json']}, '@timestamp': 49},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/etc/group']}, '@timestamp': 50},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/etc/passwd']}, '@timestamp': 51},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/etc/shadow']}, '@timestamp': 52},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'tar', 'args': ['/etc/gshadow']}, '@timestamp': 53},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.ssh/id_rsa']}, '@timestamp': 54},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.ssh/id_rsa.pub']}, '@timestamp': 55},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.ssh/id_ed25519']}, '@timestamp': 56},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.ssh/id_ed25519.pub']}, '@timestamp': 57},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.ssh/authorized_keys']}, '@timestamp': 58},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.ssh/authorized_keys2']}, '@timestamp': 59},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.ssh/known_hosts']}, '@timestamp': 60},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.bash_history']}, '@timestamp': 61},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/etc/hosts']}, '@timestamp': 62},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.ssh/id_rsa']}, '@timestamp': 63},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.ssh/id_rsa.pub']}, '@timestamp': 64},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.ssh/id_ed25519']}, '@timestamp': 65},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.ssh/id_ed25519.pub']}, '@timestamp': 66},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.ssh/authorized_keys']}, '@timestamp': 67},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.ssh/authorized_keys2']}, '@timestamp': 68},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.ssh/known_hosts']}, '@timestamp': 69},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.bash_history']}, '@timestamp': 70},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.aws/credentials']}, '@timestamp': 71},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.aws/config']}, '@timestamp': 72},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.aws/credentials']}, '@timestamp': 73},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.aws/config']}, '@timestamp': 74},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/root/.docker/config.json']}, '@timestamp': 75},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/home/*/.docker/config.json']}, '@timestamp': 76},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/etc/group']}, '@timestamp': 77},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/etc/passwd']}, '@timestamp': 78},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/etc/shadow']}, '@timestamp': 79},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'gzip', 'args': ['/etc/gshadow']}, '@timestamp': 80},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.ssh/id_rsa']}, '@timestamp': 81},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.ssh/id_rsa.pub']}, '@timestamp': 82},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.ssh/id_ed25519']}, '@timestamp': 83},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.ssh/id_ed25519.pub']}, '@timestamp': 84},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.ssh/authorized_keys']}, '@timestamp': 85},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.ssh/authorized_keys2']}, '@timestamp': 86},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.ssh/known_hosts']}, '@timestamp': 87},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.bash_history']}, '@timestamp': 88},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/etc/hosts']}, '@timestamp': 89},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.ssh/id_rsa']}, '@timestamp': 90},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.ssh/id_rsa.pub']}, '@timestamp': 91},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.ssh/id_ed25519']}, '@timestamp': 92},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.ssh/id_ed25519.pub']}, '@timestamp': 93},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.ssh/authorized_keys']}, '@timestamp': 94},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.ssh/authorized_keys2']}, '@timestamp': 95},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.ssh/known_hosts']}, '@timestamp': 96},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.bash_history']}, '@timestamp': 97},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.aws/credentials']}, '@timestamp': 98},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.aws/config']}, '@timestamp': 99},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.aws/credentials']}, '@timestamp': 100},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.aws/config']}, '@timestamp': 101},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/root/.docker/config.json']}, '@timestamp': 102},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/home/*/.docker/config.json']}, '@timestamp': 103},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/etc/group']}, '@timestamp': 104},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/etc/passwd']}, '@timestamp': 105},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/etc/shadow']}, '@timestamp': 106},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': 'hdiutil', 'args': ['/etc/gshadow']}, '@timestamp': 107},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.ssh/id_rsa']}, '@timestamp': 108},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.ssh/id_rsa.pub']}, '@timestamp': 109},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.ssh/id_ed25519']}, '@timestamp': 110},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.ssh/id_ed25519.pub']}, '@timestamp': 111},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.ssh/authorized_keys']}, '@timestamp': 112},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.ssh/authorized_keys2']}, '@timestamp': 113},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.ssh/known_hosts']}, '@timestamp': 114},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.bash_history']}, '@timestamp': 115},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/etc/hosts']}, '@timestamp': 116},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.ssh/id_rsa']}, '@timestamp': 117},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.ssh/id_rsa.pub']}, '@timestamp': 118},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.ssh/id_ed25519']}, '@timestamp': 119},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.ssh/id_ed25519.pub']}, '@timestamp': 120},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.ssh/authorized_keys']}, '@timestamp': 121},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.ssh/authorized_keys2']}, '@timestamp': 122},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.ssh/known_hosts']}, '@timestamp': 123},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.bash_history']}, '@timestamp': 124},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.aws/credentials']}, '@timestamp': 125},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.aws/config']}, '@timestamp': 126},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.aws/credentials']}, '@timestamp': 127},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.aws/config']}, '@timestamp': 128},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/root/.docker/config.json']}, '@timestamp': 129},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/home/*/.docker/config.json']}, '@timestamp': 130},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/etc/group']}, '@timestamp': 131},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/etc/passwd']}, '@timestamp': 132},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/etc/shadow']}, '@timestamp': 133},
 {'event': {'category': ['process'], 'type': ['start']}, 'process': {'name': '7z', 'args': ['/etc/gshadow']}, '@timestamp': 134}]
```
...
```python
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'sc.exe', 'args': ['config', 'create', 'start', 'delete', 'stop', 'pause'], 'parent': {'name': 'wscript.exe'}}, 'user': {'id': 'vCf'}, '@timestamp': 0},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'pe': {'original_file_name': 'sc.exe'}, 'args': ['config', 'create', 'start', 'delete', 'stop', 'pause'], 'parent': {'name': 'wmic.exe'}}, 'user': {'id': 'yyF'}, '@timestamp': 1}]
```
...
```python
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'control.exe', 'executable': 'ZFy', 'parent': {'name': 'WorkFolders.exe'}}, '@timestamp': 0},
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'name': 'control.exe', 'executable': 'XIU', 'parent': {'name': 'WorkFolders.exe'}}, '@timestamp': 1}]
```
...
```python
[{'event': {'category': ['file'], 'type': ['change']}, 'file': {'path': '/etc/sudoersXIUtkNI'}, '@timestamp': 0},
 {'event': {'category': ['file'], 'type': ['change']}, 'file': {'path': '/private/etc/sudoersixTFlEzswuEEXp'}, '@timestamp': 1}]
```
...
```python
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'executable': 'C:\\XIUtkNI', 'working_directory': 'k:\\', 'name': 'rundll32.exe', 'parent': {'name': 'explorer.exe'}}, '@timestamp': 0}]
```
...
```python
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'cscript.exe'}}, '@timestamp': 0},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'wscript.exe'}}, '@timestamp': 1},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'PowerShell.EXE'}}, '@timestamp': 2},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'Cmd.Exe'}}, '@timestamp': 3},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'MSHTA.EXE'}}, '@timestamp': 4},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'RUNDLL32.EXE'}}, '@timestamp': 5},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'REGSVR32.EXE'}}, '@timestamp': 6},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'MSBuild.exe'}}, '@timestamp': 7},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'InstallUtil.exe'}}, '@timestamp': 8},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'RegAsm.exe'}}, '@timestamp': 9},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'RegSvcs.exe'}}, '@timestamp': 10},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'msxsl.exe'}}, '@timestamp': 11},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'CONTROL.EXE'}}, '@timestamp': 12},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'EXPLORER.EXE'}}, '@timestamp': 13},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'Microsoft.Workflow.Compiler.exe'}}, '@timestamp': 14},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'parent': {'name': 'svchost.exe', 'args': ['Schedule']}, 'args': ['C:\\Users\\*', 'C:\\ProgramData\\*', 'C:\\Windows\\Temp\\*', 'C:\\Windows\\Tasks\\*', 'C:\\PerfLogs\\*', 'C:\\Intel\\*', 'C:\\Windows\\Debug\\*', 'C:\\HP\\*'], 'pe': {'original_file_name': 'msiexec.exe'}}, '@timestamp': 15}]
```
...
```python
[{'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 8000, 'ip': 'aa79:ec58:8d14:2981:f18d:f2a6:6b1f:4182'}, 'source': {'ip': '10.193.74.7'}, '@timestamp': 0},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 8000, 'ip': '9a9f:e89a:c443:b67a:770a:2cd7:3602:9e1e'}, 'source': {'ip': '172.25.51.169'}, '@timestamp': 1},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 8000, 'ip': '104.129.204.102'}, 'source': {'ip': '192.168.111.13'}, '@timestamp': 2},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 8000, 'ip': '149.239.86.175'}, 'source': {'ip': '10.186.159.60'}, '@timestamp': 3},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 8000, 'ip': '112.141.185.70'}, 'source': {'ip': '172.28.87.162'}, '@timestamp': 4},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 8000, 'ip': 'b781:36ad:968a:1fd9:42e0:603d:9566:7ca8'}, 'source': {'ip': '192.168.155.175'}, '@timestamp': 5}]
```
...
```python
[{'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9001, 'ip': 'aa79:ec58:8d14:2981:f18d:f2a6:6b1f:4182'}, 'source': {'ip': '10.193.74.7'}, '@timestamp': 0},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9001, 'ip': '9a9f:e89a:c443:b67a:770a:2cd7:3602:9e1e'}, 'source': {'ip': '172.25.51.169'}, '@timestamp': 1},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9001, 'ip': '104.129.204.102'}, 'source': {'ip': '192.168.111.13'}, '@timestamp': 2},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9030, 'ip': '149.239.86.175'}, 'source': {'ip': '10.186.159.60'}, '@timestamp': 3},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9030, 'ip': '112.141.185.70'}, 'source': {'ip': '172.28.87.162'}, '@timestamp': 4},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9030, 'ip': 'b781:36ad:968a:1fd9:42e0:603d:9566:7ca8'}, 'source': {'ip': '192.168.155.175'}, '@timestamp': 5},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9001, 'ip': '21ff:ce1f:c206:4389:a7:5646:506a:fac3'}, 'source': {'ip': '10.81.180.150'}, '@timestamp': 6},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9001, 'ip': '156.105.128.203'}, 'source': {'ip': '172.26.39.143'}, '@timestamp': 7},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9001, 'ip': '93.16.168.118'}, 'source': {'ip': '192.168.247.115'}, '@timestamp': 8},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9030, 'ip': 'cde8:687a:c169:7ee6:e8d4:8f4f:b2cc:3459'}, 'source': {'ip': '10.239.247.149'}, '@timestamp': 9},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9030, 'ip': 'e2fc:2265:c4e2:24bd:4b82:92c6:7ee8:2ac8'}, 'source': {'ip': '172.23.133.247'}, '@timestamp': 10},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 9030, 'ip': '147.172.30.18'}, 'source': {'ip': '192.168.231.61'}, '@timestamp': 11}]
```
...
```python
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['user', '/ad', '/add'], 'parent': {'name': 'vCf'}}, '@timestamp': 0},
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['user', '/ad', '/add'], 'parent': {'name': 'yyF'}}, '@timestamp': 1}]
```
...
```python
[{'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5809, 'ip': '10.214.62.131'}, 'source': {'ip': '170.121.236.89'}, '@timestamp': 0},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5801, 'ip': '172.31.81.251'}, 'source': {'ip': '119.10.44.216'}, '@timestamp': 1},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5809, 'ip': '192.168.147.58'}, 'source': {'ip': '104.129.204.102'}, '@timestamp': 2},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5807, 'ip': '10.140.246.126'}, 'source': {'ip': '199.127.185.194'}, '@timestamp': 3},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5807, 'ip': '172.23.193.59'}, 'source': {'ip': '116.114.240.76'}, '@timestamp': 4},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5806, 'ip': '192.168.44.10'}, 'source': {'ip': '197.7.114.246'}, '@timestamp': 5}]
```
...
```python
[{'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5809, 'ip': '107.31.65.130'}, 'source': {'ip': '10.193.74.7'}, '@timestamp': 0},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5807, 'ip': '119.10.44.216'}, 'source': {'ip': '172.25.51.169'}, '@timestamp': 1},
 {'event': {'category': ['network']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5802, 'ip': '115.189.242.190'}, 'source': {'ip': '192.168.140.246'}, '@timestamp': 2},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5809, 'ip': '3e09:df7f:5d4f:9e31:a728:d9ab:7cd7:de7e'}, 'source': {'ip': '10.232.229.224'}, '@timestamp': 3},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5806, 'ip': '149.102.124.168'}, 'source': {'ip': '172.18.192.161'}, '@timestamp': 4},
 {'event': {'category': ['network_traffic']}, 'network': {'transport': 'tcp'}, 'destination': {'port': 5804, 'ip': 'a7:5646:506a:fac2:8499:c98f:ee87:44c3'}, 'source': {'ip': '192.168.9.26'}, '@timestamp': 5}]
```
...
```python
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'grep', 'args': ['parallels*', 'vmware*', 'virtualbox*', 'Manufacturer*'], 'parent': {'executable': 'ZFy'}}, 'user': {'id': 'XIU'}, '@timestamp': 0},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'egrep', 'args': ['parallels*', 'vmware*', 'virtualbox*', 'Manufacturer*'], 'parent': {'executable': 'tkN'}}, 'user': {'id': 'Ioi'}, '@timestamp': 1}]
```
...
[{'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'net.exe', 'args': ['view']}, '@timestamp': 0},
 ...
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['view'], 'parent': {'name': 'ZFy'}}, '@timestamp': 4},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['time', '\\\\*'], 'parent': {'name': 'XIU'}}, '@timestamp': 5},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'pe': {'original_file_name': 'net1.exe'}, 'args': ['view'], 'parent': {'name': 'tkN'}}, '@timestamp': 6},
 {'event': {'type': ['start'], 'category': ['process']}, 'process': {'pe': {'original_file_name': 'net1.exe'}, 'args': ['time', '\\\\*'], 'parent': {'name': 'Ioi'}}, '@timestamp': 7},
 ...
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['view'], 'parent': {'name': 'xTF'}}, '@timestamp': 12},
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'name': 'net1.exe', 'args': ['time', '\\\\*'], 'parent': {'name': 'lEz'}}, '@timestamp': 13},
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'pe': {'original_file_name': 'net1.exe'}, 'args': ['view'], 'parent': {'name': 'swu'}}, '@timestamp': 14},
 {'event': {'type': ['process_started'], 'category': ['process']}, 'process': {'pe': {'original_file_name': 'net1.exe'}, 'args': ['time', '\\\\*'], 'parent': {'name': 'EEX'}}, '@timestamp': 15}]
```
